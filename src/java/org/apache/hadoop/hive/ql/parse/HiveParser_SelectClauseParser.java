// $ANTLR 3.4 SelectClauseParser.g 2014-09-24 20:03:03
...
@after { gParent.msgs.pop(); }
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: hintClause, hintClause, selectTrfmClause, hintClause, selectList, selectList
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final HiveParser_SelectClauseParser.selectTrfmClause_return selectTrfmClause() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: StringLiteral, selectExpressionList, outRec, columnNameTypeList, inSerde, outSerde, aliasList, inRec
            // token labels: 
    ...
    public final HiveParser_SelectClauseParser.trfmClause_return trfmClause() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: StringLiteral, aliasList, selectExpressionList, outRec, inRec, outSerde, columnNameTypeList, inSerde
            // token labels: 
