// $ANTLR 3.4 org/apache/hadoop/hive/ql/parse/HiveLexer.g 2015-05-14 18:00:52
...
public class HiveLexer extends Lexer {
    ...
    public final void mRegexComponent() throws RecognitionException {
        try {
            ...
            // org/apache/hadoop/hive/ql/parse/HiveLexer.g:
            {
            if ( input.LA(1)=='$'||(input.LA(1) >= '(' && input.LA(1) <= '+')||(input.LA(1) >= '-' && input.LA(1) <= '.')||(input.LA(1) >= '0' && input.LA(1) <= '9')
            		||input.LA(1)=='?'||(input.LA(1) >= 'A' && input.LA(1) <= '[')||(input.LA(1) >= ']' && input.LA(1) <= '_')||(input.LA(1) >= 'a' && input.LA(1) <= '}') ) {
                input.consume();
            }
            else {
                MismatchedSetException mse = new MismatchedSetException(null,input);
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            do {
                int alt8=3;
                switch ( input.LA(1) ) {//检查是单引号包裹还是双引号包裹
                case '\'':
                    {
                    alt8=1;
                    }
