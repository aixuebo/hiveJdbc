// $ANTLR 3.5.2 HiveLexer.g 2015-08-27 23:06:13
...
public class HiveLexer extends Lexer {
	...
	public final void mKW_STREAMTABLE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:184:15: ( 'STREAMTABLE' )
			// HiveLexer.g:184:17: 'STREAMTABLE'
			{
			match("STREAMTABLE"); 
	...
	public final void mKW_HOLD_DDLTIME() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:185:16: ( 'HOLD_DDLTIME' )
			// HiveLexer.g:185:18: 'HOLD_DDLTIME'
			{
			match("HOLD_DDLTIME"); 
	...
	public final void mKW_CLUSTERSTATUS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:186:17: ( 'CLUSTERSTATUS' )
			// HiveLexer.g:186:19: 'CLUSTERSTATUS'
			{
			match("CLUSTERSTATUS"); 
	...
	public final void mKW_UTC() throws RecognitionException {
		try {
			int _type = KW_UTC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:187:7: ( 'UTC' )
			// HiveLexer.g:187:9: 'UTC'
			{
			match("UTC"); 
	...
	public final void mKW_UTCTIMESTAMP() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:188:16: ( 'UTC_TMESTAMP' )
			// HiveLexer.g:188:18: 'UTC_TMESTAMP'
			{
			match("UTC_TMESTAMP"); 
	...
	public final void mKW_LONG() throws RecognitionException {
		try {
			int _type = KW_LONG;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:189:8: ( 'LONG' )
			// HiveLexer.g:189:10: 'LONG'
			{
			match("LONG"); 
	...
	public final void mKW_DELETE() throws RecognitionException {
		try {
			int _type = KW_DELETE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:190:10: ( 'DELETE' )
			// HiveLexer.g:190:12: 'DELETE'
			{
			match("DELETE"); 
	...
	public final void mKW_PLUS() throws RecognitionException {
		try {
			int _type = KW_PLUS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:191:8: ( 'PLUS' )
			// HiveLexer.g:191:10: 'PLUS'
			{
			match("PLUS"); 
	...
	public final void mKW_MINUS() throws RecognitionException {
		try {
			int _type = KW_MINUS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:192:9: ( 'MINUS' )
			// HiveLexer.g:192:11: 'MINUS'
			{
			match("MINUS"); 
	...
	public final void mKW_FETCH() throws RecognitionException {
		try {
			int _type = KW_FETCH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:193:9: ( 'FETCH' )
			// HiveLexer.g:193:11: 'FETCH'
			{
			match("FETCH"); 
	...
	public final void mKW_INTERSECT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:194:13: ( 'INTERSECT' )
			// HiveLexer.g:194:15: 'INTERSECT'
			{
			match("INTERSECT"); 
	...
	public final void mKW_VIEW() throws RecognitionException {
		try {
			int _type = KW_VIEW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:195:8: ( 'VIEW' )
			// HiveLexer.g:195:10: 'VIEW'
			{
			match("VIEW"); 
	...
	public final void mKW_IN() throws RecognitionException {
		try {
			int _type = KW_IN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:196:6: ( 'IN' )
			// HiveLexer.g:196:8: 'IN'
			{
			match("IN"); 
	...
	public final void mKW_DATABASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:197:12: ( 'DATABASE' )
			// HiveLexer.g:197:14: 'DATABASE'
			{
			match("DATABASE"); 
	...
	public final void mKW_DATABASES() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:198:13: ( 'DATABASES' )
			// HiveLexer.g:198:15: 'DATABASES'
			{
			match("DATABASES"); 
	...
	public final void mKW_MATERIALIZED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:199:16: ( 'MATERIALIZED' )
			// HiveLexer.g:199:18: 'MATERIALIZED'
			{
			match("MATERIALIZED"); 
	...
	public final void mKW_SCHEMA() throws RecognitionException {
		try {
			int _type = KW_SCHEMA;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:200:10: ( 'SCHEMA' )
			// HiveLexer.g:200:12: 'SCHEMA'
			{
			match("SCHEMA"); 
	...
	public final void mKW_SCHEMAS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:201:11: ( 'SCHEMAS' )
			// HiveLexer.g:201:13: 'SCHEMAS'
			{
			match("SCHEMAS"); 
	...
	public final void mKW_GRANT() throws RecognitionException {
		try {
			int _type = KW_GRANT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:202:9: ( 'GRANT' )
			// HiveLexer.g:202:11: 'GRANT'
			{
			match("GRANT"); 
	...
	public final void mKW_REVOKE() throws RecognitionException {
		try {
			int _type = KW_REVOKE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:203:10: ( 'REVOKE' )
			// HiveLexer.g:203:12: 'REVOKE'
			{
			match("REVOKE"); 
	...
	public final void mKW_SSL() throws RecognitionException {
		try {
			int _type = KW_SSL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:204:7: ( 'SSL' )
			// HiveLexer.g:204:9: 'SSL'
			{
			match("SSL"); 
	...
	public final void mKW_UNDO() throws RecognitionException {
		try {
			int _type = KW_UNDO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:205:8: ( 'UNDO' )
			// HiveLexer.g:205:10: 'UNDO'
			{
			match("UNDO"); 
	...
	public final void mKW_LOCK() throws RecognitionException {
		try {
			int _type = KW_LOCK;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:206:8: ( 'LOCK' )
			// HiveLexer.g:206:10: 'LOCK'
			{
			match("LOCK"); 
	...
	public final void mKW_LOCKS() throws RecognitionException {
		try {
			int _type = KW_LOCKS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:207:9: ( 'LOCKS' )
			// HiveLexer.g:207:11: 'LOCKS'
			{
			match("LOCKS"); 
	...
	public final void mKW_UNLOCK() throws RecognitionException {
		try {
			int _type = KW_UNLOCK;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:208:10: ( 'UNLOCK' )
			// HiveLexer.g:208:12: 'UNLOCK'
			{
			match("UNLOCK"); 
	...
	public final void mKW_SHARED() throws RecognitionException {
		try {
			int _type = KW_SHARED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:209:10: ( 'SHARED' )
			// HiveLexer.g:209:12: 'SHARED'
			{
			match("SHARED"); 
	...
	public final void mKW_EXCLUSIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:210:13: ( 'EXCLUSIVE' )
			// HiveLexer.g:210:15: 'EXCLUSIVE'
			{
			match("EXCLUSIVE"); 
	...
	public final void mKW_PROCEDURE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:211:13: ( 'PROCEDURE' )
			// HiveLexer.g:211:15: 'PROCEDURE'
			{
			match("PROCEDURE"); 
	...
	public final void mKW_UNSIGNED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:212:12: ( 'UNSIGNED' )
			// HiveLexer.g:212:14: 'UNSIGNED'
			{
			match("UNSIGNED"); 
	...
	public final void mKW_WHILE() throws RecognitionException {
		try {
			int _type = KW_WHILE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:213:9: ( 'WHILE' )
			// HiveLexer.g:213:11: 'WHILE'
			{
			match("WHILE"); 
	...
	public final void mKW_READ() throws RecognitionException {
		try {
			int _type = KW_READ;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:214:8: ( 'READ' )
			// HiveLexer.g:214:10: 'READ'
			{
			match("READ"); 
	...
	public final void mKW_READS() throws RecognitionException {
		try {
			int _type = KW_READS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:215:9: ( 'READS' )
			// HiveLexer.g:215:11: 'READS'
			{
			match("READS"); 
	...
	public final void mKW_PURGE() throws RecognitionException {
		try {
			int _type = KW_PURGE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:216:9: ( 'PURGE' )
			// HiveLexer.g:216:11: 'PURGE'
			{
			match("PURGE"); 
	...
	public final void mKW_RANGE() throws RecognitionException {
		try {
			int _type = KW_RANGE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:217:9: ( 'RANGE' )
			// HiveLexer.g:217:11: 'RANGE'
			{
			match("RANGE"); 
	...
	public final void mKW_ANALYZE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:218:11: ( 'ANALYZE' )
			// HiveLexer.g:218:13: 'ANALYZE'
			{
			match("ANALYZE"); 
	...
	public final void mKW_BEFORE() throws RecognitionException {
		try {
			int _type = KW_BEFORE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:219:10: ( 'BEFORE' )
			// HiveLexer.g:219:12: 'BEFORE'
			{
			match("BEFORE"); 
	...
	public final void mKW_BETWEEN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:220:11: ( 'BETWEEN' )
			// HiveLexer.g:220:13: 'BETWEEN'
			{
			match("BETWEEN"); 
	...
	public final void mKW_BOTH() throws RecognitionException {
		try {
			int _type = KW_BOTH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:221:8: ( 'BOTH' )
			// HiveLexer.g:221:10: 'BOTH'
			{
			match("BOTH"); 
	...
	public final void mKW_BINARY() throws RecognitionException {
		try {
			int _type = KW_BINARY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:222:10: ( 'BINARY' )
			// HiveLexer.g:222:12: 'BINARY'
			{
			match("BINARY"); 
	...
	public final void mKW_CROSS() throws RecognitionException {
		try {
			int _type = KW_CROSS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:223:9: ( 'CROSS' )
			// HiveLexer.g:223:11: 'CROSS'
			{
			match("CROSS"); 
	...
	public final void mKW_CONTINUE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:224:12: ( 'CONTINUE' )
			// HiveLexer.g:224:14: 'CONTINUE'
			{
			match("CONTINUE"); 
	...
	public final void mKW_CURSOR() throws RecognitionException {
		try {
			int _type = KW_CURSOR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:225:10: ( 'CURSOR' )
			// HiveLexer.g:225:12: 'CURSOR'
			{
			match("CURSOR"); 
	...
	public final void mKW_TRIGGER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:226:11: ( 'TRIGGER' )
			// HiveLexer.g:226:13: 'TRIGGER'
			{
			match("TRIGGER"); 
	...
	public final void mKW_RECORDREADER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:227:16: ( 'RECORDREADER' )
			// HiveLexer.g:227:18: 'RECORDREADER'
			{
			match("RECORDREADER"); 
	...
	public final void mKW_RECORDWRITER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:228:16: ( 'RECORDWRITER' )
			// HiveLexer.g:228:18: 'RECORDWRITER'
			{
			match("RECORDWRITER"); 
	...
	public final void mKW_SEMI() throws RecognitionException {
		try {
			int _type = KW_SEMI;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:229:8: ( 'SEMI' )
			// HiveLexer.g:229:10: 'SEMI'
			{
			match("SEMI"); 
	...
	public final void mKW_LATERAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:230:11: ( 'LATERAL' )
			// HiveLexer.g:230:13: 'LATERAL'
			{
			match("LATERAL"); 
	...
	public final void mKW_TOUCH() throws RecognitionException {
		try {
			int _type = KW_TOUCH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:231:9: ( 'TOUCH' )
			// HiveLexer.g:231:11: 'TOUCH'
			{
			match("TOUCH"); 
	...
	public final void mKW_ARCHIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:232:11: ( 'ARCHIVE' )
			// HiveLexer.g:232:13: 'ARCHIVE'
			{
			match("ARCHIVE"); 
	...
	public final void mKW_UNARCHIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:233:13: ( 'UNARCHIVE' )
			// HiveLexer.g:233:15: 'UNARCHIVE'
			{
			match("UNARCHIVE"); 
	...
	public final void mKW_COMPUTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:234:11: ( 'COMPUTE' )
			// HiveLexer.g:234:13: 'COMPUTE'
			{
			match("COMPUTE"); 
	...
	public final void mKW_STATISTICS() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:235:14: ( 'STATISTICS' )
			// HiveLexer.g:235:16: 'STATISTICS'
			{
			match("STATISTICS"); 
	...
	public final void mKW_USE() throws RecognitionException {
		try {
			int _type = KW_USE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:236:7: ( 'USE' )
			// HiveLexer.g:236:9: 'USE'
			{
			match("USE"); 
	...
	public final void mKW_OPTION() throws RecognitionException {
		try {
			int _type = KW_OPTION;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:237:10: ( 'OPTION' )
			// HiveLexer.g:237:12: 'OPTION'
			{
			match("OPTION"); 
	...
	public final void mKW_CONCATENATE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:238:15: ( 'CONCATENATE' )
			// HiveLexer.g:238:17: 'CONCATENATE'
			{
			match("CONCATENATE"); 
	...
	public final void mKW_SHOW_DATABASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:239:17: ( 'SHOW_DATABASE' )
			// HiveLexer.g:239:19: 'SHOW_DATABASE'
			{
			match("SHOW_DATABASE"); 
	...
	public final void mKW_UPDATE() throws RecognitionException {
		try {
			int _type = KW_UPDATE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:240:10: ( 'UPDATE' )
			// HiveLexer.g:240:12: 'UPDATE'
			{
			match("UPDATE"); 
	...
	public final void mKW_RESTRICT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:241:12: ( 'RESTRICT' )
			// HiveLexer.g:241:14: 'RESTRICT'
			{
			match("RESTRICT"); 
	...
	public final void mKW_CASCADE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:242:11: ( 'CASCADE' )
			// HiveLexer.g:242:13: 'CASCADE'
			{
			match("CASCADE"); 
	...
	public final void mKW_SKEWED() throws RecognitionException {
		try {
			int _type = KW_SKEWED;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:243:10: ( 'SKEWED' )
			// HiveLexer.g:243:12: 'SKEWED'
			{
			match("SKEWED"); 
	...
	public final void mKW_ROLLUP() throws RecognitionException {
		try {
			int _type = KW_ROLLUP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:244:10: ( 'ROLLUP' )
			// HiveLexer.g:244:12: 'ROLLUP'
			{
			match("ROLLUP"); 
	...
	public final void mKW_CUBE() throws RecognitionException {
		try {
			int _type = KW_CUBE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:245:8: ( 'CUBE' )
			// HiveLexer.g:245:10: 'CUBE'
			{
			match("CUBE"); 
	...
	public final void mKW_DIRECTORIES() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:246:15: ( 'DIRECTORIES' )
			// HiveLexer.g:246:17: 'DIRECTORIES'
			{
			match("DIRECTORIES"); 
	...
	public final void mKW_FOR() throws RecognitionException {
		try {
			int _type = KW_FOR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:247:7: ( 'FOR' )
			// HiveLexer.g:247:9: 'FOR'
			{
			match("FOR"); 
	...
	public final void mKW_WINDOW() throws RecognitionException {
		try {
			int _type = KW_WINDOW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:248:10: ( 'WINDOW' )
			// HiveLexer.g:248:12: 'WINDOW'
			{
			match("WINDOW"); 
	...
	public final void mKW_UNBOUNDED() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:249:13: ( 'UNBOUNDED' )
			// HiveLexer.g:249:15: 'UNBOUNDED'
			{
			match("UNBOUNDED"); 
	...
	public final void mKW_PRECEDING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:250:13: ( 'PRECEDING' )
			// HiveLexer.g:250:15: 'PRECEDING'
			{
			match("PRECEDING"); 
	...
	public final void mKW_FOLLOWING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:251:13: ( 'FOLLOWING' )
			// HiveLexer.g:251:15: 'FOLLOWING'
			{
			match("FOLLOWING"); 
	...
	public final void mKW_CURRENT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:252:11: ( 'CURRENT' )
			// HiveLexer.g:252:13: 'CURRENT'
			{
			match("CURRENT"); 
	...
	public final void mKW_LESS() throws RecognitionException {
		try {
			int _type = KW_LESS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:253:8: ( 'LESS' )
			// HiveLexer.g:253:10: 'LESS'
			{
			match("LESS"); 
	...
	public final void mKW_MORE() throws RecognitionException {
		try {
			int _type = KW_MORE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:254:8: ( 'MORE' )
			// HiveLexer.g:254:10: 'MORE'
			{
			match("MORE"); 
	...
	public final void mKW_OVER() throws RecognitionException {
		try {
			int _type = KW_OVER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:255:8: ( 'OVER' )
			// HiveLexer.g:255:10: 'OVER'
			{
			match("OVER"); 
	...
	public final void mKW_GROUPING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:256:12: ( 'GROUPING' )
			// HiveLexer.g:256:14: 'GROUPING'
			{
			match("GROUPING"); 
	...
	public final void mKW_SETS() throws RecognitionException {
		try {
			int _type = KW_SETS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:257:8: ( 'SETS' )
			// HiveLexer.g:257:10: 'SETS'
			{
			match("SETS"); 
	...
	public final void mKW_TRUNCATE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:258:12: ( 'TRUNCATE' )
			// HiveLexer.g:258:14: 'TRUNCATE'
			{
			match("TRUNCATE"); 
	...
	public final void mKW_NOSCAN() throws RecognitionException {
		try {
			int _type = KW_NOSCAN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:259:10: ( 'NOSCAN' )
			// HiveLexer.g:259:12: 'NOSCAN'
			{
			match("NOSCAN"); 
	...
	public final void mKW_PARTIALSCAN() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:260:15: ( 'PARTIALSCAN' )
			// HiveLexer.g:260:17: 'PARTIALSCAN'
			{
			match("PARTIALSCAN"); 
	...
	public final void mKW_USER() throws RecognitionException {
		try {
			int _type = KW_USER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:261:8: ( 'USER' )
			// HiveLexer.g:261:10: 'USER'
			{
			match("USER"); 
	...
	public final void mKW_ROLE() throws RecognitionException {
		try {
			int _type = KW_ROLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:262:8: ( 'ROLE' )
			// HiveLexer.g:262:10: 'ROLE'
			{
			match("ROLE"); 
	...
	public final void mKW_INNER() throws RecognitionException {
		try {
			int _type = KW_INNER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:263:9: ( 'INNER' )
			// HiveLexer.g:263:11: 'INNER'
			{
			match("INNER"); 
	...
	public final void mKW_EXCHANGE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:264:12: ( 'EXCHANGE' )
			// HiveLexer.g:264:14: 'EXCHANGE'
			{
			match("EXCHANGE"); 
	...
	public final void mDIV() throws RecognitionException {
		try {
			int _type = DIV;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:294:5: ( 'DIV' )
			// HiveLexer.g:294:7: 'DIV'
			{
			match("DIV"); 
	...
	public final void mExponent() throws RecognitionException {
		try {
			// HiveLexer.g:322:5: ( ( 'e' | 'E' ) ( PLUS | MINUS )? ( Digit )+ )
	...
	public final void mRegexComponent() throws RecognitionException {
		try {
			// HiveLexer.g:328:5: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | PLUS | STAR | QUESTION | MINUS | DOT | LPAREN | RPAREN | LSQUARE | RSQUARE | LCURLY | RCURLY | BITWISEXOR | BITWISEOR | DOLLAR )
			// HiveLexer.g:
			{
	...
	public final void mCharSetLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:342:5: ( StringLiteral | '0' 'X' ( HexDigit | Digit )+ )
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// HiveLexer.g:343:5: StringLiteral
					{
					mStringLiteral(); 
					...
					break;
				case 2 :
					// HiveLexer.g:344:7: '0' 'X' ( HexDigit | Digit )+
					{
					match('0'); 
					match('X'); 
					// HiveLexer.g:344:15: ( HexDigit | Digit )+
					int cnt9=0;
					loop9:
					while (true) {
						int alt9=2;
	...
	public final void mBigintLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:348:5: ( ( Digit )+ 'L' )
			// HiveLexer.g:349:5: ( Digit )+ 'L'
			{
			// HiveLexer.g:349:5: ( Digit )+
			int cnt11=0;
			loop11:
			while (true) {
				int alt11=2;
	...
	public final void mSmallintLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:353:5: ( ( Digit )+ 'S' )
			// HiveLexer.g:354:5: ( Digit )+ 'S'
			{
			// HiveLexer.g:354:5: ( Digit )+
			int cnt12=0;
			loop12:
			while (true) {
				int alt12=2;
	...
	public final void mTinyintLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:358:5: ( ( Digit )+ 'Y' )
			// HiveLexer.g:359:5: ( Digit )+ 'Y'
			{
			// HiveLexer.g:359:5: ( Digit )+
			int cnt13=0;
			loop13:
			while (true) {
				int alt13=2;
	...
	public final void mByteLengthLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:368:5: ( ( Digit )+ ( 'b' | 'B' | 'k' | 'K' | 'm' | 'M' | 'g' | 'G' ) )
			// HiveLexer.g:369:5: ( Digit )+ ( 'b' | 'B' | 'k' | 'K' | 'm' | 'M' | 'g' | 'G' )
			{
			// HiveLexer.g:369:5: ( Digit )+
			int cnt14=0;
			loop14:
			while (true) {
				int alt14=2;
	...
	public final void mNumber() throws RecognitionException {
		try {
			int _type = Number;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:373:5: ( ( Digit )+ ( DOT ( Digit )* ( Exponent )? | Exponent )? )
			// HiveLexer.g:374:5: ( Digit )+ ( DOT ( Digit )* ( Exponent )? | Exponent )?
			{
			// HiveLexer.g:374:5: ( Digit )+
			int cnt15=0;
			loop15:
			while (true) {
				int alt15=2;
			...
			// HiveLexer.g:374:14: ( DOT ( Digit )* ( Exponent )? | Exponent )?
			int alt18=3;
			...
			switch (alt18) {
				case 1 :
					// HiveLexer.g:374:16: DOT ( Digit )* ( Exponent )?
					{
					mDOT(); 

					// HiveLexer.g:374:20: ( Digit )*
					loop16:
					while (true) {
						int alt16=2;
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:378:5: ( ( Letter | Digit ) ( Letter | Digit | '_' )* | '`' ( RegexComponent )+ '`' )
			int alt21=2;
			...
			switch (alt21) {
				case 1 :
					// HiveLexer.g:379:5: ( Letter | Digit ) ( Letter | Digit | '_' )*
					{
					...
					// HiveLexer.g:379:22: ( Letter | Digit | '_' )*
					loop19:
					while (true) {
						int alt19=2;
					...
					break;
				case 2 :
					// HiveLexer.g:380:7: '`' ( RegexComponent )+ '`'
					{
					match('`'); 
					// HiveLexer.g:380:11: ( RegexComponent )+
					int cnt20=0;
					loop20:
					while (true) {
						int alt20=2;
	...
	public final void mCharSetName() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// HiveLexer.g:384:5: ( '_' ( Letter | Digit | '_' | '-' | '.' | ':' )+ )
			// HiveLexer.g:385:5: '_' ( Letter | Digit | '_' | '-' | '.' | ':' )+
			{
			match('_'); 
			// HiveLexer.g:385:9: ( Letter | Digit | '_' | '-' | '.' | ':' )+
			int cnt22=0;
			loop22:
			while (true) {
				int alt22=2;
